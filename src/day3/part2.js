...
import { storePathInfoPart2, findCrossPart2 } from './helper'
...
const path1 = storePathInfoPart2(wire1)
const path2 = storePathInfoPart2(wire2)
const result = findCrossPart2(path1, path2)
